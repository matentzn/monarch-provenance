# Contributing to monarch-data

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
monarch-data. These guidelines are not strict rules.
...
The monarch-data team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the monarch-data technical leads
...
[issues]: https://github.com/monarchinitiative/monarch-data/issues/
[pulls]: https://github.com/monarchinitiative/monarch-data/pulls/
